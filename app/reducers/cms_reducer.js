    ...
    "head": [
        ...
        // },
        {
            ...
            customize(value, index, data) {
                ...
                onClick = { this.props.onTable.bind(this, { "operate": "changeUsingState", "data": data, "rowIndex": index }) } > { text } < /button>
            }
        }, {
            "field": "operate",
            "text": "操作",
            ...
            "value": [
                ...
                { "operate": "configPage", "icon": "fa-edit", "text": "页面编辑" },
                { "operate": "manageContent", "icon": "fa-file", "text": "内容管理" }
            ]
        }
    ],
    "list": null,
...
const channelListInit = {
    ...
    "head": [{
        ...
        "type": "operate",
        "value": [
            { "operate": "configPage", "icon": "fa-edit", "text": "设置" }
        ]
    }],
    "list": null,
    "pages": 1,
