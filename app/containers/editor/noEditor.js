...
import {getPublishFilter, getToeditFilter, getToeditData} from 'app/action_creators/editor_action_creator';
...
@connect(select)
export default class EditorNoEditorContainer extends Component {
	...
	constructor (props) {
		...
		this.state = {
			"crumbs": [
				{"path": "/home", "text": "首页"},
				{"path": "/editor/noEditor", "text": "编辑类：未编审"}
			],
			"filterInit": {},
			"filterParams": {
				"resGroup": 1
		...
		this.filterParam = {
			paramType: 0,
			param:{"graphicalType":1,"resGroup": 1,"groupState": 2}
		};
	}
				...
				<div className="page-content">
					...
					<div className="row">
						<div id="j_table" className="col-xs-12 table-responsive text-nowrap">
							<TableBox onTable={this.handleOnTable.bind(this)} {...this.state.tableInit} />
						</div>
					</div>
