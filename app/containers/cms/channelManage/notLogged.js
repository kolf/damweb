		...
		return (<div>
				...
				<Tabs type="card" onChange={this.tabChange.bind(this)}>
					...
					<Tabpane tab="标签管理" key="2">
						<TableBox {...scrollList} onTable={this.operateScrollList.bind(this)}/>
					...
					<Tabpane tab="标签图片管理" key="5">
						...
						<FocusPic {...picListData} tipMessage={{isSame:0,message:this.state.tipArr}} deleteData={this.deleteData.bind(this)} onUpdateData={this.updateDataRecemened.bind(this)}/>
					</Tabpane>
				</Tabs>
				</div>
		)
