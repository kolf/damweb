...
import {topicCfg, feFilter, saveFilter} 		  from "app/action_creators/cms_action_creator";
			        ...
			        //   return <MultiSelect list={contentArr} selectedItems={contentArr || []}/>
			          ...
			          return <MultiSelect list={_this.state.categories} selectedItems={contentArr || []} handleMultiSelect={_this.handleMultiSelect.bind(_this, index)}/>
			        	...
			        	if(contentArr[0].length < 11){
			          	...
			          	return <div><DatePicker style={{width:200}} defaultValue={contentArr[0]} format="yyyy-MM-dd HH:mm:ss" showTime={true} onChange={_this.handleTimeChange.bind(_this, 0)}/>-
			          				<DatePicker style={{width:200}} defaultValue={contentArr[1]} format="yyyy-MM-dd HH:mm:ss" showTime={true} onChange={_this.handleTimeChange.bind(_this, 1)}/></div>
			        }
			      }
			    },
			    {
