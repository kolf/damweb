...
export default class CloudDownload extends Component {
        ...
        return (
            <div className="main-content-inner">
                ...
                <div className="page-content pl-40">
                    ...
                    <Input autosize placeholder="请输入图片ID" type="textarea" autoComplete="off" onChange={ e =>{this.state.value = e.target.value}}/>
                    <hr/>
