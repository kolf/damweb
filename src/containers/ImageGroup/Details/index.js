...
class ImageGroupDetails extends Component {
  constructor(props) {
    super(props);
          ...
          <Row gutter={24}>
            <Col lg={{span: 6}}>
              <FormItem {...formItemLayout} label="组图标题">
                <p className="ant-form-text">组图标题</p>
              </FormItem>
              <FormItem label="组图说明" {...formItemLayout}>
                <p className="ant-form-text">重度雾霾盘踞 消散唯等风来重度雾霾盘踞 消散唯等风来重度雾霾盘踞 消散唯等风来重度雾霾盘踞 消散唯等风来重度雾霾盘踞 消散唯等风来重度雾霾盘踞
                  消散唯等风来重度雾霾盘踞 消散唯等风来重度雾霾盘踞 消散唯等风来</p>
              </FormItem>
              <FormItem
                {...formItemLayout}
                label="组图标签"
              ...
              <Row gutter={24}>
                <Col lg={{span: 16}}>
                  <div className="edit-view">
                    <div className="edit-view-img"
                         style={{backgroundImage: 'url(https://os.alipayobjects.com/rmsportal/QBnOOoLaAfKPirc.png)'}}>
                    </div>
                  </div>
                </Col>
                <Col lg={{span: 8}}>
                  <Form>
                    <div className="ant-row ant-form-item ant-col-offset-6">
                      <Button htmlType="submit" size="large" type="primary"><Link to={'/imageGroup/update'}>编辑组图</Link></Button>
                      <Button size="large" className="gap-left">下载组图</Button>
                    </div>
                    <Tabs type="card">
                      <TabPane tab="基本信息" key="Tab_1">
                        ...
                        <FormItem
                          ...
                          {...formItemLayout}
                        >
                          <p className="ant-form-text">重度雾霾盘踞 消散唯等风来重度雾霾盘踞 消散唯等风来重度雾霾盘踞 消散唯等风来重度雾霾盘踞 消散唯等风来重度雾霾盘踞
                            消散唯等风来重度雾霾盘踞 消散唯等风来重度雾霾盘踞 消散唯等风来重度雾霾盘踞 消散唯等风来</p>
                        </FormItem>
                        <FormItem
                          {...formItemLayout}
                          label="图片分类"
                        >
                          <Select style={{width: '100%'}} {...imgClassifyProps} disabled>
...
export default connect(mapStateToProps)(CreateForm()(ImageGroupDetails));
